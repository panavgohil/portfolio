...
return ( <section
 ...
 > <div className="max-w-5xl mx-auto">
    ...
    <p className="text-slate-300 text-lg leading-9 mt-6">
      Beyond engineering, I have represented DTU at national-level
      parliamentary debates hosted by IIT Bombay, IIT Delhi, and
      IGDTUW, strengthening my communication, leadership, and
